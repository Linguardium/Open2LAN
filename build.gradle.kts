...
modstitch {
    ...
    javaTarget = when {
        stonecutter.eval(minecraft, "=<1.16") -> 8
        stonecutter.eval(minecraft, ">1.16 <1.20.4") -> 17
    ...
    metadata {
        ...
        replacementProperties.populate {
            ...
            put("mod_issue_tracker", "https://github.com/Linguardium/open2lan/issues")
...
dependencies {
    modstitch.loom {
        modstitchModImplementation("net.fabricmc.fabric-api:fabric-api:0.116.1+1.21.1")
    }
